  ...
  return (
    ...
    >
      {/* <div className="flex justify-center">
        <h1
          className={`font-new text-3xl whitespace-pre-wrap text-center font-bold ${
      ...
      {/* <div className="w-full h-screen md:flex p-10 justify-center  items-center"> */}
      <div className="flex gap-10 justify-center items-center">
        ...
        <svg
          ...
          xml:space="preserve"
          // className={` ${isDark ? `fill-white` : `fill-darkBlue`}`}
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
